...
public class CodeGenerationVisitor implements ASTVisitor {
	...
	public void visit(BlockStatement s) {
		...
		curLoc = curLoc.getEnclosingScope();
	...
	public void visit(Declaration d) {
		...
		Type type = d.getType();
		int location = curLoc.lookup(name);
		Symbol sym = Symbol
