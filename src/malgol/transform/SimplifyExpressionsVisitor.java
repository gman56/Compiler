...
public class SimplifyExpressionsVisitor implements ASTVisitor {
    ...
    public void visit(FunctionCallExpression e) {
        ...
        LinkedList<Expression> newExp = new LinkedList<>();
        LinkedList<Statement> stmt = new LinkedList<>();
        LinkedList<Declaration> decl = new LinkedList<>();

        for(Expression exp : e.getArguments()){
            exp.accept(this);
            newExp.add(expressionResult);
            stmt.addAll(newStatements);
            decl.addAll(newDeclarations);
        }
        ...
        newVar.setType(e.getType());
        FunctionCallExpression functionCallExpression = new FunctionCallExpression(null, e.getName(), newExp);
    ...
    public void visit(ReturnStatement s) {
        s.getExpression().accept(this);
        Statement ret = new ReturnStatement(null, expressionResult);
